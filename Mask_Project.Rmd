...
Our team performed a three day study to report if the California Polytechnic State University’s library was meeting the required minimum of 65% of its students and staff wearing medical grade masks. In order to minimize bias in our data, we constructed our study by randomly choosing the days, times, and library floors at which we would collect our data. 
